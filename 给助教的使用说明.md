...
- **Docker镜像地址**：`crpi-t07boaz31v5le95c.cn-hangzhou.personal.cr.aliyuncs.com/ai_travel_planner_zsh/ai_travel_planner_zsh_522025720032`
- **最新版本**：v1.0.0
...
| 标签 | 说明 | 拉取命令 |
|------|------|---------|
| `latest` | 最新版本 | `docker pull crpi-t07boaz31v5le95c.cn-hangzhou.personal.cr.aliyuncs.com/ai_travel_planner_zsh/ai_travel_planner_zsh_522025720032:latest` |
| `v1.0.0` | 稳定版本1.0.0 | `docker pull crpi-t07boaz31v5le95c.cn-hangzhou.personal.cr.aliyuncs.com/ai_travel_planner_zsh/ai_travel_planner_zsh_522025720032:v1.0.0` |
| `main` | 主分支最新构建 | `docker pull crpi-t07boaz31v5le95c.cn-hangzhou.personal.cr.aliyuncs.com/ai_travel_planner_zsh/ai_travel_planner_zsh_522025720032:main` |
...
# abc123def456   crpi-t07boaz31v5le95c.cn-hangzhou.personal.cr.aliyuncs.com/ai_travel_planner_zsh/ai_travel_planner_zsh_522025720032:latest   Up 2 minutes   0.0.0.0:8080->8080/tcp
```
...
### 链接
- **GitHub仓库**：https://github.com/zhengshuanghao/git_homework_3
- **Docker镜像**：crpi-t07boaz31v5le95c.cn-hangzhou.personal.cr.aliyuncs.com/ai_travel_planner_zsh/ai_travel_planner_zsh_522025720032
